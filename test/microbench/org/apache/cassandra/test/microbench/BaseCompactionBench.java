...
public abstract class BaseCompactionBench extends CQLTester
{
    @Param( {"DEFAULT"} )
    ...
    public final void setup() throws Throwable
    {
        ...
        try (Session session = sessionNet())
        {
            ...
            DatabaseDescriptor.setCompactionThroughputMebibytesPerSec(compactionMbSecThrottle);
    ...
    static final ByteBuffer BLOB = ByteBuffer.allocate(Integer.getInteger("benchmark.blobSize", 100)); // checkstyle: ignore
