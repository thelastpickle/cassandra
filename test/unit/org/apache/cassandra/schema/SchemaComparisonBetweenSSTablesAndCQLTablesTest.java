...
public class SchemaComparisonBetweenSSTablesAndCQLTablesTest
{
    ...
    private static void initializeSSTableMetadataForTableMap() throws Exception
    {
        ssTableMetadataForTableMap.put(TABLE_1_NAME,
                                       Util.metadataFromSSTable(Descriptor.fromFile(new File(ssTableResourceRootPath + "test_1-7ab21491848211ee825e31532694b0d3/bb-2-bti-Data.db")),
                                                                ksName, TABLE_1_NAME));

        ssTableMetadataForTableMap.put(TABLE_2_NAME,
                                       Util.metadataFromSSTable(Descriptor.fromFile(new File(ssTableResourceRootPath + "test_2-83ac0dd1848211ee825e31532694b0d3/bb-1-bti-Data.db")),
                                                                ksName, TABLE_2_NAME));

        ssTableMetadataForTableMap.put(TABLE_3_NAME,
                                       Util.metadataFromSSTable(Descriptor.fromFile(new File(ssTableResourceRootPath + "test_3-88b6cb80848211ee825e31532694b0d3/bb-1-bti-Data.db")),
                                                                ksName, TABLE_3_NAME));

        ssTableMetadataForTableMap.put(TABLE_4_NAME,
                                       Util.metadataFromSSTable(Descriptor.fromFile(new File(ssTableResourceRootPath + "test_4-8bf57bc0848211ee825e31532694b0d3/bb-1-bti-Data.db")),
                                                                ksName, TABLE_4_NAME));

        ssTableMetadataForTableMap.put(TABLE_5_NAME,
                                       Util.metadataFromSSTable(Descriptor.fromFile(new File(ssTableResourceRootPath + "test_5-9db47b90848211ee825e31532694b0d3/bb-1-bti-Data.db")),
                                                                ksName, TABLE_5_NAME));
    }
