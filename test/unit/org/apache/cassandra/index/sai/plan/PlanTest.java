...
public class PlanTest
{
    ...
    private final static RowFilter rowFilter1 = RowFilter.builder(true).add(pred1).build();
    private final static RowFilter rowFilter12 = RowFilter.builder(true).add(pred1).add(pred2).build();
    private final static RowFilter rowFilter123 = RowFilter.builder(true).add(pred1).add(pred2).add(pred3).build();
    ...
    public void prettyPrint()
    {
        ...
        Plan.KeysIteration sort = factory.annSort(union, ordering);
        Plan.RowsIteration fetch = factory.fetch(sort);
        Plan.RowsIteration filter = factory.recheckFilter(RowFilter.builder(true).add(pred1).add(pred2).add(pred3).build(), fetch);
        Plan.RowsIteration limit = factory.limit(filter, 3);
