...
public class RangeCommandIteratorTest
{
    ...
    public void testRangeQueried()
    {
        ...
        RangeCommandIterator data = RangeCommandIterator.create(replicaPlans, command, 1, 1000, vnodeCount, nanoTime());
        ...
        data = RangeCommandIterator.create(replicaPlans, command, vnodeCount, 1000, vnodeCount, nanoTime());
        ...
        replicaPlans = replicaPlanIterator(keyRange, keyspace, false);
        data = RangeCommandIterator.create(replicaPlans, command, 1, 1, vnodeCount, nanoTime());
        ...
        data = RangeCommandIterator.create(replicaPlans, command, 1, 1000, vnodeCount, nanoTime());
        verifyRangeCommandIterator(data, rows, 1, vnodeCount);
