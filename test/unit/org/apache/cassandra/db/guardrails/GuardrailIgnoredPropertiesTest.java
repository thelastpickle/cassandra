...
public class GuardrailIgnoredPropertiesTest extends GuardrailTester
{
    ...
    public void before()
    {
        defaultTablePropertiesIgnored = DatabaseDescriptor.getGuardrailsConfig().getTablePropertiesIgnored();

        // but actually ignore "comment"
        DatabaseDescriptor.getGuardrailsConfig().setTablePropertiesIgnored(ImmutableSet.of("comment"));
    }

    @After
    public void after()
    {
        DatabaseDescriptor.getGuardrailsConfig().setTablePropertiesIgnored(defaultTablePropertiesIgnored);
    }
    ...
    public void testPropertySkipping()
    {
        ...
        Guardrails.tableProperties.guard(tableAttributes.updatedProperties(), tableAttributes::removeProperty, null);
