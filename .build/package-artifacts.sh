...
docker run --rm -v "${cassandra_dir}:/home/build/cassandra" -v ~/.m2/repository/:/home/build/.m2/repository/ cassandra-packaging-bullseye:${image_tag} /home/build/build-artifacts.sh ${java_version}
