...
import static org.apache.cassandra.config.CassandraRelevantProperties.THREAD_MONITOR_AUTO_CALIBRATE;
import static org.apache.cassandra.config.CassandraRelevantProperties.THREAD_MONITOR_ENABLED;
import static org.apache.cassandra.config.CassandraRelevantProperties.THREAD_MONITOR_SLEEP_INTERVAL_NS;
...
{
    public static final boolean IS_ENABLED = THREAD_MONITOR_ENABLED.getBoolean();
     ...
     */
    private static final long SLEEP_INTERVAL_NS = THREAD_MONITOR_SLEEP_INTERVAL_NS.getLong();
    private static final boolean AUTO_CALIBRATE = THREAD_MONITOR_AUTO_CALIBRATE.getBoolean() && SLEEP_INTERVAL_NS > 0;

    private static final Sleeper SLEEPER = AUTO_CALIBRATE ? new CalibratingSleeper(SLEEP_INTERVAL_NS) : new Sleeper();
    ...
    public static class CalibratingSleeper extends Sleeper
    {
        ...
        long nanoTime()
        {
            return MonotonicClock.Global.preciseTime.now();
        }
    }
}
