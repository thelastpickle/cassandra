 ...
 */
public abstract class AbstractNetworkTopologyStrategy extends AbstractReplicationStrategy
{
    protected IEndpointSnitch snitch;
    protected Map<String, Integer> datacenters;
    private static final Logger logger = LoggerFactory.getLogger(AbstractNetworkTopologyStrategy.class);

    public AbstractNetworkTopologyStrategy(String keyspaceName, TokenMetadata tokenMetadata, IEndpointSnitch snitch, Map<String, String> configOptions) throws ConfigurationException
    {
    ...
    {
        return super.hasSameSettings(other) && ((AbstractNetworkTopologyStrategy) other).datacenters.equals(datacenters);
    }
}
