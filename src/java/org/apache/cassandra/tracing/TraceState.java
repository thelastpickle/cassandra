...
public abstract class TraceState implements ProgressEventNotifier
{
    ...
    {
        assert coordinator != null || sessionId == null : "coordinator can't be null unless sessionId also is";
        assert sessionId != null || coordinator == null : "sessionId can't be null unless coordinator also is";
