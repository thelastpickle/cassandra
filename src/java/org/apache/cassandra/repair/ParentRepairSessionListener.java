...
public interface ParentRepairSessionListener
{
     ...
     */
    void onRegistered(TimeUUID sessionId, ActiveRepairService.ParentRepairSession session);

    /**
     * Call when parent repair session is removed
     */
    void onRemoved(TimeUUID sessionId, ActiveRepairService.ParentRepairSession session);
