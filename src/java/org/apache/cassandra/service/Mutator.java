...
public interface Mutator
{
     ...
     */
    void persistBatchlog(Collection<Mutation> mutations, long queryStartNanoTime, ReplicaPlan.ForWrite replicaPlan, TimeUUID batchUUID);

    /**
     * Used to clear the given batch id. Usually invoked as part of
     * {@link #mutateAtomically(Collection, ConsistencyLevel, boolean, long, ClientRequestsMetrics, ClientState)}.
     */
    void clearBatchlog(String keyspace, ReplicaPlan.ForWrite replicaPlan, TimeUUID batchUUID);
