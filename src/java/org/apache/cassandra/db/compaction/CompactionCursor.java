...
public class CompactionCursor implements SSTableCursorMerger.MergeListener, AutoCloseable
{
    ...
    public CompactionCursor(OperationType type, Collection<SSTableReader> readers, CompactionController controller, RateLimiter limiter, long nowInSec, TimeUUID compactionId)
    {
