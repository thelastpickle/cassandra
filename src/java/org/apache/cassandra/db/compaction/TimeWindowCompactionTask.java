...
public class TimeWindowCompactionTask extends CompactionTask
{
    ...
    public TimeWindowCompactionTask(CompactionRealm realm, LifecycleTransaction txn, long gcBefore, boolean ignoreOverlaps, TimeWindowCompactionStrategy strategy)
    {
