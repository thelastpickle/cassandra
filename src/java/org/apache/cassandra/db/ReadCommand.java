...
public abstract class ReadCommand extends MonitorableImpl implements ReadQuery
{
    ...
    private UnfilteredPartitionIterator withMetricsRecording(UnfilteredPartitionIterator iter, final TableMetrics metric, final long startTimeNanos)
    {
        class MetricRecording extends Transformation<UnfilteredRowIterator>
        {
             ...
             * - cells that aren't live anymore (either expired through TTL or deleted) : 
             *   1 tombstone per cell
             * - Rows that aren't live and have no cell (DELETEs performed on the primary key) : 
             *   1 tombstone per row 
             * 
             * We avoid counting rows as tombstones if they contain only expired cells.
             */
            @Override
