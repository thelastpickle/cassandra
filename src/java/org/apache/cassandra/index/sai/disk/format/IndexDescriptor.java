...
public class IndexDescriptor
{
    ...
    public Set<Component> getLivePerSSTableComponents()
    {
        ...
        return perSSTableComponents.stream()
                                   .map(c -> c.type.createComponent(componentName(c)))
    ...
    public Set<Component> getLivePerIndexComponents(IndexContext indexContext)
    {
        ...
        return perIndexComponents.containsKey(indexContext.getIndexName())
               ? perIndexComponents.get(indexContext.getIndexName())
                                   .stream()
                                   .map(c -> c.type.createComponent(componentName(c, indexContext)))
                                                                         .collect(Collectors.toSet())
    ...
    public IndexOutputWriter openPerSSTableOutput(IndexComponent component, boolean append) throws IOException
    {
        ...
        IndexOutputWriter writer = IndexFileUtils.instance().openOutput(file, append, version);
    ...
    {
        final FileHandle.Builder builder = StorageProvider.instance.fileHandleBuilderFor(this, indexComponent);
        return builder.complete();
    }

    public FileHandle createPerIndexFileHandle(IndexComponent indexComponent, IndexContext indexContext)
    {
        final FileHandle.Builder builder = StorageProvider.instance.fileHandleBuilderFor(this, indexComponent, indexContext);
        return builder.complete();
    }
    ...
    {
        Component customComponent = component.type.createComponent(componentName(component, indexContext));
