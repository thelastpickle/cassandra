...
* xref:cql/function.adoc#scalar-functions[scalar functions] that take a number of values and produce an output
* xref:cql/function.adoc#aggregate-fuctions[aggregate functions] that aggregate multiple rows resulting from a `SELECT` statement
