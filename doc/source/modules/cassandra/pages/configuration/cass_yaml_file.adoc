...
<<<<<<< HEAD:doc/source/configuration/cass_yaml_file.rst
...
-----------------------
=======
>>>>>>> 28f29838a4 (changes to python scripts, addition of modules):doc/source/modules/cassandra/pages/configuration/cass_yaml_file.adoc
*This option is commented out by default.*
